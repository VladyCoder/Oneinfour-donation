;(function($) {
    ...
    $(document).ready(function(){
        // let sidNavSelectAllItem = $('.sideNav-wrapper .select-all-tab');
        // if(sidNavSelectAllItem){
        //     sidNavSelectAllItem.on('click', function(e){
        //         var items = $(this).parent().find('.sideNav-item');
        //         items.each(function(idx, item){
        //             $(item).addClass('active');
        //             let contentTag = $(item).attr('content-tag');
        //             if(contentTag) $('#' + contentTag).addClass('active');
        //         })
                
        //     });
        // };
        
        let sidNavItem = $('.sideNav-wrapper .sideNav-item');
        if(sidNavItem){
            sidNavItem.on('click', function(e){
                $('.sideNav-wrapper .sideNav-item.active').removeClass('active');
                $('.toggle_sidenav_content.active').removeClass('active');
                $(this).addClass('active');
                let contentTag = $(this).attr('content-tag');
                if(contentTag) $('.' + contentTag).addClass('active');
                
                if(contentTag == "about_supporter" && $('#good_cause.supporters-viewer')){
                    $('#good_cause.supporters-viewer').show();
                }else{
                    $('#good_cause.supporters-viewer').hide();
                }
            })
        }        
    });
