...
<head>
    ...
    <title>One In Four Children - Contact Us</title>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    ...
                    <h3 class="cause-title"><a href="#">WE HELP THOUSANDS OF CHILDREND TO GET THEIR EDUCATION, NOW WE NEED YOUR HELP.</a></h3>
...
-->
    ...
    <section id="contact-content-pointer" class="row contact-content page-content">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="contact_page_title">have an idea to help us ? - contact us</h3>
                    <p class="contact_page_para">Those who are crazy enough to think they can change the world, are the ones that end up chaning the world.</p>
                    <form class="row m0 contact-form" id="contactForm">
                        ...
                        <label for="subject" class="error" style="display:none"></label>
                        <input type="text" class="form-control" id="subject" name="subject" placeholder="Subject">
                        <label for="message" class="error" style="display:none"></label>
                        <textarea name="message" id="message" placeholder="Message" class="form-control"></textarea>
                        <div class="success" style="display:none">email is sent successfully</div>
                        <div class="fail error" style="display:none">email failed. please try again</div>
                        <input type="submit" value="submit" class="btn-primary">
                    </form>
                    <!--<h3 class="contact_page_title map-title">find us on map</h3>-->
                    <!--<div id="mapBox" class="row m0" data-lat="-27.47736" data-lon="153.02842" data-zoom="15" data-marker="images/map-marker.png"></div>-->
                </div>
                <!--
                    ...
                    <div class="row m0 address_box">
                        <div class="inner row">
                            ...
                            <address>
                                ...
                                BNE 4000. <br>
                                <br>
                                Phone:+61420241004 <br>
                                <br>
                                <a href="#">Need help? Have questions? Get in touch!.</a>
                            </address>
                        </div>
                    </div>
                </div>
